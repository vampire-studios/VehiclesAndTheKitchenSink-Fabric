...
public class BlockItem extends ArmorItem {
   @Deprecated
   ...
   public ActionResult useOnBlock(ItemUsageContext context) {
      ...
      return actionResult != ActionResult.SUCCESS && this.isFood() ? this.use(context.getWorld(), context.getPlayer(), context.getHand()).getResult() : actionResult;
   }
