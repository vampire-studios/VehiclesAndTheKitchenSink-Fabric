...
import io.github.vampirestudios.vks.entity.vehicles.SandBusEntity;
 ...
 * Author: MrCrayfish
 */
public class RenderSandBus extends AbstractRenderVehicle<SandBusEntity> {
    ...
    @Override
    public void render(SandBusEntity entity, MatrixStack matrixStack, VertexConsumerProvider renderTypeBuffer, float partialTicks, int light) {
        this.renderDamagedPart(entity, SpecialModels.SAND_BUS_BODY.getModel(), matrixStack, renderTypeBuffer, light);
    ...
    @Override
    public void applyPlayerModel(SandBusEntity entity, PlayerEntity player, PlayerEntityModel<AbstractClientPlayerEntity> model, float partialTicks) {
