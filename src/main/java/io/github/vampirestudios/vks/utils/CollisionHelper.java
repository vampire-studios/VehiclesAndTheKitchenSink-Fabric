...
{
    public static Box getBlockBounds(Direction facing, double x1, double y1, double z1, double x2, double y2, double z2)
    {
        double[] bounds = fixRotation(facing, x1, z1, x2, z2);
        return new Box(bounds[0], y1, bounds[1], bounds[2], y2, bounds[3]);
    }
